...
export default function AdminMarketPricesPage() {
  return (
    <DashboardLayout sidebarLinks={adminLinks} sidebarTitle="Admin Panel">
      <SectionHeader title="Market Prices" subtitle="Manage daily market price records" action={<Button size="sm">+ Add Price</Button>} />
      <div className="overflow-x-auto rounded-lg border">
        <table className="w-full text-sm">
          <thead className="bg-muted">
            <tr>
              {["Product", "Category", "Min ৳", "Max ৳", "Unit", "Market", "Date", "Actions"].map((h) => (
